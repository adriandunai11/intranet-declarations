...
class DeclarationTemplateCatalogService
{
    ...
    {
        return [
            $this->tax('under_30_mothers_discount', 'ANYA30', '30 év alatti anyák kedvezménye', 'Adóelőleg-nyilatkozat a 30 év alatti anyák kedvezményének érvényesítéséről', 'A nyilatkozatot az a 30 év alatti anya adhatja be, aki vér szerinti vagy örökbefogadott gyermeke, illetve magzata után családi kedvezményre jogosult, és kéri, hogy a munkáltató a kedvezményt már az adóelőleg megállapításakor vegye figyelembe.', 10, ['30 év alatti anyák', 'adóelőleg', 'ANYA30']),
            ...
            $this->tax('mothers_of_four_discount', 'ANYNTA', 'Két, három, illetve négy vagy több gyermeket nevelő anyák kedvezménye', 'Adóelőleg-nyilatkozat a két gyermeket nevelő anyák, a három gyermeket nevelő anyák és a négy vagy több gyermeket nevelő anyák kedvezményének érvényesítéséről', 'A nyilatkozatot az a két, három, illetve négy vagy több gyermeket nevelő anya adhatja be, aki kéri, hogy a munkáltató a rá vonatkozó kedvezményt az adóelőleg megállapításakor figyelembe vegye.', 30, ['két gyermekes anya', 'három gyermekes anya', 'négy vagy több gyermekes anya', 'ANYNTA']),
            ...
            $this->tax('under_25_tax_discount_waiver', 'ANY25NEM', '25 év alattiak kedvezményének mellőzése', 'Adóelőleg-nyilatkozat a 25 év alatti fiatalok kedvezményének részben vagy egészben történő mellőzéséről', 'A kedvezményt a munkáltató automatikusan figyelembe veszi. Ezt a nyilatkozatot csak akkor kell kitölteni, ha a kedvezményt részben vagy egyáltalán nem szeretné igénybe venni.', 70, ['25 év alatti', 'mellőzés', 'ANY25NEM']),
            ...
            $this->own('under_3_child_work_schedule_statement', 'Nyilatkozat 3 év alatti gyermek neveléséről', 'Nyilatkozat a kisgyermeket nevelőkre vonatkozó munkaidő-beosztási szabályok alkalmazásához.', 'A munkavállaló ezen a nyilatkozaton jelzi, hogy nevel-e 3 év alatti gyermeket, a gyermek vele közös háztartásban él-e, egyedül neveli-e, és kéri-e a kisgyermeket nevelőkre vonatkozó munkaidő-beosztási szabályok figyelembevételét. A pontos munkajogi szabályokat a megadott adatok alapján a munkaügy állapítja meg.', DeclarationTemplate::GROUP_EMPLOYMENT, DeclarationTemplate::CATEGORY_EMPLOYMENT, DeclarationTemplate::REQUIRED_OPTIONAL, DeclarationTemplate::REVIEW_ROLE_PAYROLL, true, 140, ['3 év alatti gyermek', 'Mt. 113. §', 'munkaidő-beosztás', 'kisgyermekes munkavállaló']),
        ];
    }
